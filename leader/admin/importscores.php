...
list($user, $pusername) = getPostValues("lbusername", "pusername");

// Check if they sent the right vars
if (!checkPostVars("pusername")) { ?>
Enter data:

<form action="importscores.php" method="POST">
	<input name="lbusername" value="Username" type="text">
	<input name="pusername" value="P-Username" type="text">
...
No user. <a href="http://marbleblast.com/index.php/profile?impfail=1">Continue...</a>
<?php
	die();
}
